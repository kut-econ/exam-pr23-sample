...
1. 32GiBは何MiBですか？ 32768MiB
2. 32GBは何MBですか？ 32000MB
3. 1MiBと1MBの間には何バイトの差がありますか？  48576バイト
...
1. 16進数の4bを10進数で表記しなさい。75
2. 10進数の200を2進数で表記しなさい。11001000
3. 2進数の101011を16進数で表記しなさい。2b
